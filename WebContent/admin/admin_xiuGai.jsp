  ...
  <body>
    <div class ="div_title">
	 ...
	 <form action="AdminServlet.do" >
	 	<input type="hidden" name="flag" value="xiuGaiAdmin" />
		 ...
		 <table class="edit_table" >
		 		<tr>
		 			...
		 			<tr>
		 				...
		 				<td>
		 				<label  class="validate_info" id="password_msg" >数字或英文,6-20位</label></td>	
		 		</tr>
		 		
		 			<tr>
		 				<td class="td_info">重复密码:</td>	
		 				<td>
		 					<input type="text" value="${admin.password }"  class="txtbox" id="pwdconfirm" /> 
		 				</td>
		 				<td>
		 				<label  class="validate_info" id="pwdconfirm_msg">请重复输入密码</label></td>	
		 		</tr>
		 		
		 		<tr>
		 			<td class="td_info">备注信息:</td>
		 			<td><textarea rows="4" cols="27" name="note" class="txtarea">${admin.note }</textarea> 
		 				</td>
		 				<td>
						<label></label></td>	
		 		</tr>
