...
<html>
  ...
  <body>
     <div class ="div_title">
		 <div class="div_titlename"> <img src="images/san_jiao.gif" ><span>员工修改</span></div>
	 </div>
	 
	 <form action="StaffServlet.do" method="post">
	 	<input type="hidden" name="flag" value="xiuStaff" />
	 	...
	 	<table class="edit_table" >
	 		...
	 		<tr>
	 			<td class="td_info"> </td>	
	 			<td> 
	 			<input id="subm" class="form_btn" type="submit" value="修改" /> 
